...
SAMPLE_ACCOUNTS = [
    {
        ...
        "outreach": {
            "evan@acme.ai": {
                ...
                "follow_up_1": "Evan — following up on the pipeline note. If the timing's off, just say so. If there's interest, happy to share what the first two weeks look like.",
                "follow_up_2": "Still relevant? Happy to park this if the focus is elsewhere right now."
            }
        },
        "follow_up_log": {
            "evan@acme.ai": {
    ...
    },
    {
        ...
        "outreach": {
            "brodie@terzo.com": {
                ...
                "follow_up_1": "Brodie — any traction on the pipeline infrastructure question? Happy to share what week one looks like if that's useful.",
                "follow_up_2": "Still on the radar? If the timing's off I'll circle back next quarter."
            }
        },
        "follow_up_log": {},
    ...
    },
    {
        ...
        "outreach": {
            "deniz@mindra.io": {
                ...
                "follow_up_1": "Deniz — still thinking about the pipeline infrastructure question. If the LinkedIn post was a moment of frustration and not an active problem, no worries. But if it's still real, worth 20 minutes.",
                "follow_up_2": "Last note on this — happy to park it if the timing isn't right."
            }
        },
        "follow_up_log": {
            "deniz@mindra.io": {
    ...
    },
    {
        ...
        "outreach": {
            "josh@rex.run": {
                ...
                "follow_up_1": "Following up ahead of our call — any context you'd want to share beforehand?",
                "follow_up_2": "Still good for the intro call? Happy to reschedule if timing shifted."
            }
        },
        "follow_up_log": {
            "josh@rex.run": {
    ...
    },
    {
        ...
        "outreach": {
            "alex@fibinaci.com": {
                ...
                "follow_up_1": "Alex — just following up on the NDA + demo step. Happy to proceed whenever you're ready.",
                "follow_up_2": "Still interested in the advisory conversation? No pressure either way."
            }
        },
        "follow_up_log": {},
